...
3. No exemplo, solicitamos ao usuário que inserisse seu nome e calculamos o número de caracteres usando a função len(). Tentamos concatenar esse valor com uma string para exibir uma mensagem.
